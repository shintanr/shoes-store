...
<body>
    ...
    <div class="row">
        <div class="col-1">
            <a type="button" class="btn btn-warning" href="/seller">Refresh</a>
        </div>
        <div class="col-1">
            <a type="button" class="btn btn-info" href="/createseller">Tambah</a>
        </div>
        <div class="col-1">
            <a type="button" class="btn btn-danger" href="/trashseller">Terhapus</a>
        </div>
        <div class="col">
            <!-- Dropdown Start -->
